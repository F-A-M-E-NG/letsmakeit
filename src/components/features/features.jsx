                ...
                <li>
                  <Col className="pd-0 hidden-xs" sm={6}>
                    <div className="contents-l mr-b30">
                      <h2>Bond Fund</h2>
                      <p>
                        The FUOSMCOS Bond fund is a managed investment scheme
                        invested primarily in debt instruments to provide
                        intervention working capital for small and medium
                        enterprises to meet liquidityand on-going business
                        demands.
                      </p>
                      <Link to="/details/bondfund" className="btn1">
                        Get Started
                      </Link>
                    </div>
                  </Col>
                ...
                <li className="rl">
                  <Col className="pd-0 floatright mr-b30 hidden-xs" sm={6}>
                    <div className="contents-r">
                      <h2>Growth Fund</h2>
                      <p>
                        This fund provides financing, structure and mentorship
                        for small and medium enterprises. We structure unique,
                        individualised financing solutions using shareholders’
                        loans, equity, royalties and term loans – or any
                        combination of these and provides value-added expert
                        assistance whilst ensuring the funds of the investor is
                        safe and yielding sustainable cashflow.
                      </p>

                      <Link to="/details/growthfund" className="btn1">
                        Get Started
                      </Link>
                    </div>
                  </Col>
                ...
                <li>
                  <Col className="pd-0 hidden-xs" sm={6}>
                    <div className="contents-l mr-b30">
                      <h2>Premium Fund</h2>
                      <p>
                        The FUOSMCOS Premium Fund is a mid-term Investment
                        vehicle for the discerning investor, providing a viable
                        source of financing for lower middle market companies in
                        Africa. FUOSMCOS Financial Services is actively raising
                        a N1B fund that seeks to deploy N5m – 50m of growth
                        capital investments in small and medium sized
                        enterprises via the use of mezzanine debt and
                        quasi-equity instruments to firms operating across West
                        Africa.
                      </p>
                      <Link to="/details/premiumfund" className="btn1">
                        Get Started
                      </Link>
                    </div>
                  </Col>
